...
BRUSHED.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : '_include/img/slider-images/01 Kinetic Grasshopper.jpg', title : '<div class="slide-content">Fabnovation<h3>innovation begins by making</h3> </div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/02 Kaoss Pad.jpg', title : '<div class="slide-content">Fabnovation<h3>innovation begins by making</h3> </div>', thumb : '', url : ''},
